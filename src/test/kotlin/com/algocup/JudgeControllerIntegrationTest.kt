...
import com.algocup.config.TestApplicationConfiguration
import com.algocup.domain.StatusCode
...
class JudgeControllerIntegrationTest {
    ...
    fun judgesJavaCorrectSolution(problemId: String, solutionId: String) {
        ...
        val result = submissionsListener.judge(Submission(sourceCode, "0-0", "0", problemId, LocalDateTime.now(), 0, "dummy_token"))
    ...
    fun returnsFormattedMessageIfCompilationError() {
        ...
        val result = submissionsListener.judge(Submission(skeletonCode, "0-0", "3", "fib", LocalDateTime.now(), 0, "dummy_token"))
